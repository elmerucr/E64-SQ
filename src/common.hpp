...
#define VICV_CYCLES_PER_FRAME	(VICV_PIXELS_PER_SCANLINE+VICV_PIXELS_HBLANK)*(VICV_SCANLINES+VICV_SCANLINES_VBLANK)
#define VICV_CLOCK_SPEED	VICV_CYCLES_PER_FRAME*FPS
#define BLITTER_CYCLES_PER_FRAME	4*VICV_CYCLES_PER_FRAME
#define SYSTEM_CLOCK_SPEED	VICV_CLOCK_SPEED
